...
const Signin = () => {
  ...
  const { signInWithEmailAndPasswordFunc, signInWithGoogleFunc } = useContext(AuthContext);
  ...
  const handleSignin = async (e) => {
    e.preventDefault();
    try {
      await signInWithEmailAndPasswordFunc(form.email, form.password);
  ...
  return (
    ...
    >
      <div className="w-full max-w-md p-8 rounded-2xl backdrop-blur-xl border border-white/10 bg-white/5 shadow-lg">
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full ${
                darkMode ? "bg-white/10 text-white placeholder-white/50" : "bg-white text-black placeholder-gray-500"
              }`}
            />
          </div>
        ...
        >
          ...
          <svg className="w-5 h-5" viewBox="0 0 533.5 544.3">
            <path fill="#4285F4" d="M533.5 278.4c0-18.4-1.5-36.1-4.4-53.3H272v100.9h146.9c-6.3 34.1-25.2 63-53.7 82.3v68.3h86.8c50.7-46.7 80.5-115.7 80.5-198.2z" />
            <path fill="#34A853" d="M272 544.3c72.6 0 133.5-24 178-65.2l-86.8-68.3c-24.1 16.1-55 25.5-91.2 25.5-70.1 0-129.5-47.3-150.8-111.2H32.1v69.9c44.5 87.3 135.8 149.3 239.9 149.3z" />
            <path fill="#FBBC05" d="M121.2 331.3c-10.4-31-10.4-64.3 0-95.3V166.1H32.1c-42.9 85.5-42.9 187.6 0 273.1l89.1-69.9z" />
            <path fill="#EA4335" d="M272 107.4c37.8-.6 73.8 13.4 101.2 39.6l75.7-75.7C404.9 24 343 0 272 0 167.9 0 76.6 62 32.1 149.3l89.1 69.9C142.5 154.7 201.9 107.4 272 107.4z" />
          </svg>
